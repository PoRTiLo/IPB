...
// set
void Activity::activity( const std::string activityE ) {

	this->m_activity = activityE;
}
...
// set
void Activity::spec( const std::string specE ) {
...
// set
void Activity::text( const std::string textE ) {
