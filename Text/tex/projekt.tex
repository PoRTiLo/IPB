...
\projectinfo{
  ...
  %===========================================================================
  %Klicova slova
  keywords.cs={Klí?ová slova v ?eském jazyce.}, %klicova slova v ceskem jazyce
  keywords.en={Klí?ová slova v anglickém jazyce.}, %klicova slova v anglickem jazyce
  %Abstract
  abstract.cs={Výtah (abstrakt) práce v ?eském jazyce.}, % abstrakt v ceskem jazyce
  abstract.en={Výtah (abstrakt) práce v anglickém jazyce.}, % abstrakt v anglickem jazyce
  %Prohlaseni
  declaration={Prohla?uji, ?e jsem tuto bakalá?skou práci vypracoval samostatn? pod vedením pana ...},
  %Podekovani (nepovinne)
  acknowledgment={Zde je mo?né uvést pod?kování vedoucímu práce a t?m, kte?í poskytli odbornou pomoc.} % nepovinne
}
