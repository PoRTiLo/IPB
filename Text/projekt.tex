...
\projectinfo{
  ...
  %===========================================================================
  %Klicova slova
  keywords.cs={Jabber, XMPP, robot, datamining, dolování dat.}, %klicova slova v ceskem jazyce
...
%Prohlaseni
\declaration{Prohla¹uji, ¾e jsem tuto bakaláøskou práci vypracoval samostatnì pod vedením pana Ing. Josefa Mlícha.
Uvedl jsem v¹echny literární prameny a publikace, ze kterých jsem èerpal.}

%Podekovani (nepovinne)
\acknowledgment{Tímto bych chtìl podìkovat mému vedoucímu bakaláøské práce Ing. Josefovi Mlíchovi za ochotu a kladný pøístup pøi konzultacích. Dále za poskytnutí hardware na nìm¾ bì¾el program a sbíral data.}
