...
\begin{figure}[ht]
\begin{center}
\includegraphics[scale=.6]{drawing1.pdf}
...
Za dobu, která pøesahuje 4 mìsíce, bylo nasbíráno témìø 200\,MB dat. Napøíklad tabulka, která uchovává data pro data mining popsaný v~následující podkapitole, obsahuje pøe 115 tisíc záznamù. Na druhou stranu entity zamìøené na roz¹íøené statusy, konkrétnì to jsou geoloc, tune, mood a~activity, disponují s~men¹ím poètem záznamù, který se poèítá pouze ve stovkách. Tento omezený poèet, jak ji¾ bylo uvedeno, je výsledkem men¹í podpory tìchto roz¹íøení ze strany klientù.
...
\begin{figure}[ht]
\begin{center}
\includegraphics[scale=.75]{doc.pdf}
