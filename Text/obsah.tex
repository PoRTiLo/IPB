...
Tabulka \ref{tabSouhrn} souhrnnì prezentuje nasbíraná data v jednotlivých kategoriích roz¹íøení. Prvními zji¹tìnými údaji je tvoøen druhý sloupec, kterým je shrnut poèet u¾ivatelù podporujících daný standard. Jak druhý tak i tøetí sloupec se skládá ze dvou èísel, která jsou  vzájemnì oddìlena znakem lomítko \textit{\textbackslash}. První údaj uvádí poèet u¾iteèných záznamù z celkového poètu. Konkrétnì v druhém sloupci to je poèet u¾ivatelù, kteøí ¹íøili u¾iteèné informace, ku poètu u¾ivatelù, je¾ ¹íøili jakákoliv data, tedy i prázdná. Tabulku uzavírá pøehled prùmìrného poètu záznamù na jednoho u¾ivatele.
...
\begin{figure}[ht]
\begin{center}
\includegraphics[scale=.80]{pic/plot3d1.pdf}
...
\rowcolor[gray]{0.9}
\textbf{-} &\textbf{1} 	& \textbf{2} & \textbf{3} & \textbf{4}& \textbf{5}& \textbf{6}& \textbf{7}& \textbf{8}& \textbf{9}& \textbf{10}& \textbf{11}& \textbf{12} & \textbf{13}& \textbf{14}&\textbf{15}&\textbf{16}&\textbf{17}&\textbf{18}&\textbf{19}&\textbf{20}&\textbf{21}&\textbf{22} \\
