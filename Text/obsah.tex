...
Druhá èást této kapitoly je zamìøena na Jabber klienta nebo--li robota, který je implementován v jazyce C++ pouze s konzolovým rozhraním. Robot v této práci hraje roli pasivního u¾ivatele, který informace pouze pøijímá. Ve vybraných pøípadech doká¾e u¾ivatele ze svého seznamu kontaktù vyzvat k zaslání odpovìdi s informacemi na odpovìï, o kterou ¾ádal. Struktura samotného robota je popsána ní¾e a reprezentována obrázkem \ref{picRobot}. V èásti o Jabber robotovi jsou také uvedeny informace o knihovnì \textit{gloox}, kterou je zprostøedkovány v¹echny nále¾itosti Jabber komunikace.
