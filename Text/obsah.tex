...
Druhá èást této kapitoly je zamìøena na robota, co¾ je Jabber klient implementován v jazyce C++ s konzolovým rozhraním. Robot v této práci hraje roli pasivního u¾ivatele, který informace pouze pøijímá. Ve vybraných pøípadech doká¾e u¾ivatele ve svém kontakt listu vyzvat k zaslání odpovìdi s informacemi na po¾adovanou ¾ádost. Struktura samotného robota je popsána ní¾e a reprezentována obrázkem è. \ref{picRobot}. Na konci èásti o Jabber robotovi bude zmínìno o knihovnì \textit{gloox} \cite{gloox}, kterou je zprostøedkovány v¹echny nále¾itosti Jabber komunikace.
