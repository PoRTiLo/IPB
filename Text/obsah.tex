...
Transformace dat tvoøí tøetí èást z celkového procesu dobývání znalostí z databází. Do této doby data pro¹la ji¾ nìkolika kroky. V první fázi byla sbírána Jabber komunikace, která je popsána v první kapitole. Druhá fáze byla zamìøena na zú¾ení výsledné mno¾iny a proto byla vybrána jen data relevantní k této práci. I pøes tyto kroky relaèní databáze obsahuje velký poèet dat, která se nenachází ve stavu, kdy by mohla být pou¾ita jako zdroj pro data minig. Jak bude popsáno dále vìt¹ina metod pro dolování dat pracuje pouze s daty, která obsahují kvantitativní promìnné. Za tímto úèelem je potøeba v¹echny atributy tabulky z databáze, které mají být nadále pou¾ívány, pøevést na mìøitelné hodnoty.  

mno¾ina $$ A\ = \{Available, Chat, Away, DND, XA, Unavailable\} $$ a mno¾ina $$\beta = \{xx,xx,xx,xx,xx,xx\}$$
