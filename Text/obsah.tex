...
V souèasné dobì k nejroz¹íøenìj¹ím psaným dorozumívacím prostøedkùm jsou øazeny real--time komunikaèní sítì. Samozøejmì tento jev je k vidìní a¾ konce minulého desetiletí. Psaná komunikace je ji¾ nìkolik století vyu¾ívána jako prostøedek k dorozumívání se mezi lidmi. Za toto období pro¹la výrazným pokrokovým vývojem, proto u ni lze nalézt mnoho èasových milníkù, které ji výraznì ovlivnily. Jako pøíklad jednoho z prvních komunikaèních kanálù lze uvést bì¾ce, kteøí èasto nesli zprávy na vzdálenosti nìkolika kilometrù. 
...
S pøibývajícími elektronickými daty, na poli a» u¾ vìdních nebo praktických oborù, pøichází potøeba je uchovávat. K tìmto úèelùm slou¾í databáze, které se svou strukturou zamìøují pøedev¹ím na snadnou kontrolu dat, vyhledávání a jejich analyzování. S rostoucím obsahem se ale ulo¾ené informace stávají pouze daty bez významu. Proto vnikla nová disciplína nazvaná \textit{data mining}, která si klade za cíl znovunalezení \uv{ztracených} informací (na první pohled neviditelných) nebo nalezení informací úplnì nových.

Pøedmìtem této bakaláøské práce bylo seznámení se s problematikou komunikace probíhající pøes Jabber sí». Konkrétním cílem bylo vytvoøení jednoduchého Jabber klienta, který by byl schopen získávat statistická data. Nashromá¾dìná data by dále slou¾ila pro pozdìj¹í analýzu a grafickou reprezentaci informací z nich získaných. Tedy cílem této práce je získat neznámé informace z real--time komunikaèní sítì Jabber. 

Bakaláøská práce je rozdìlena do ¹esti kapitol.
...
Poslední èástí je \textit{u¾ivatelské rozhraní}, které je implementováno pomocí webových slu¾eb. Jako pøíklad lze uvést slu¾bu, která zobrazuje status u¾ivatele na webové stránce. U¾ivatel pouze musí vlastnit Jabber úèet a mít pøidaného tohoto robota do seznamu kontaktù.
...
V souèasné uspìchané dobì plné moderních technologií, je dùle¾ité být informován a s tím spojená snaha vèas informovat i své okolí. Díky protokolu XMPP a real--time komunikaèní sítì jsou tyto potøeby snadno øe¹itelné. Slu¾ba, jako je prezentování vlastního statusu v klientovi prostøednictvím elementu presence, jsou pova¾ovány za samozøejmost. 
=inovovat pgormam

= dalsi zjitovane udaje, jako co by to obnasel, rizika
= 

Diskutujte mo¾né pokraèování práce.

mozne pokracovani prace bych dal jako samostatnou kapitolu nebo
potkapitolu (je nutne o tom napsat aspon 1.5 stranky textu, protoze je
to jeden bod zadani)
